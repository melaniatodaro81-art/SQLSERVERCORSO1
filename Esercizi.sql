...
-- Insert Dipendenti
INSERT INTO Dipendenti (Nome, Cognome, Email, Salario, RepartoID, DataAssunzione) VALUES
...
EXEC sp_rename 'Reparti', 'Dipartimenti'; -fatto

--RINOMINARE COLONNE
-- Nome → NomeReparto
-- Dipendenti per reparto
EXEC sp_rename 'Dipartimenti.Nome', 'NomeReparto', 'COLUMN'; -- fatto

-- Sede → SedeReparto
EXEC sp_rename 'Dipartimenti.Sede', 'SedeReparto', 'COLUMN'; --fatto
...
ALTER TABLE Dipendenti
ALTER COLUMN Email NVARCHAR(150);  --fatto

-- Rendere stipendio NOT NULL
ALTER TABLE Dipendenti
ALTER COLUMN Salario DECIMAL(10,2) NOT NULL; --fatto
...
ALTER TABLE Dipendenti
ALTER COLUMN Email NVARCHAR(150) NULL; --fatto
